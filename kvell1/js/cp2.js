//大图数组
var arrcp1fd = ["img/cp2/big/1.jpg","img/cp2/big/2.jpg","img/cp2/big/3.jpg","img/cp2/big/4.jpg"];
var arrcp1 = ["img/cp2/2.jpg","img/cp2/3.jpg","img/cp2/4.jpg","img/cp2/5.jpg"];
//获取屏幕高度
...
$boxs.each(function(i,elem){
	...
	$(elem).click(function(){
		...
		console.log(arrcp1fd2[i])
		$('.bigzhezhaodatu').attr('src',arrcp1fd2[i]);
	})
