//大图数组
var arrcp1fd7 = ["img/cp7/big/1.jpg","img/cp7/big/2.jpg","img/cp7/big/3.jpg","img/cp7/big/4.jpg"];
var arrcp1 = ["img/cp7/1.jpg","img/cp7/2.jpg","img/cp7/3.jpg","img/cp7/4.jpg"];
//获取屏幕高度
...
$boxs.each(function(i,elem){
	...
	$(elem).click(function(){
		...
		console.log(arrcp1fd7[i])
		$('.bigzhezhaodatu').attr('src',arrcp1fd7[i]);
	})
