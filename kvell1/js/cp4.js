//大图数组
var arrcp1fd = ["img/cp4/big/1.jpg","img/cp4/big/2.jpg","img/cp4/big/3.jpg","img/cp4/big/4.jpg"];
var arrcp1 = ["img/cp4/1.jpg","img/cp4/2.jpg","img/cp4/3.jpg","img/cp4/4.jpg"];
//获取屏幕高度
...
$boxs.each(function(i,elem){
	...
	$(elem).click(function(){
		...
		console.log(arrcp1fd4[i])
		$('.bigzhezhaodatu').attr('src',arrcp1fd4[i]);
	})
