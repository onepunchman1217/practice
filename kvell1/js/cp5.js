//大图数组
var arrcp1fd5 = ["img/cp5/big/1.jpg","img/cp5/big/2.jpg","img/cp5/big/3.jpg","img/cp5/big/4.jpg","img/cp5/big/5.jpg","img/cp5/big/6.jpg","img/cp5/big/7.jpg","img/cp5/big/8.jpg"];
var arrcp1 = ["img/cp5/1.jpg","img/cp5/2.jpg","img/cp5/3.jpg","img/cp5/4.jpg","img/cp5/5.jpg","img/cp5/6.jpg","img/cp5/7.jpg","img/cp5/8.jpg"];
//获取屏幕高度
...
$boxs.each(function(i,elem){
	...
	$(elem).click(function(){
		...
		console.log(arrcp1fd5[i])
		$('.bigzhezhaodatu').attr('src',arrcp1fd5[i]);
	})
