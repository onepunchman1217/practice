//大图数组
var arrcp1fd3 = ["img/cp3/big/1.jpg","img/cp3/big/2.jpg","img/cp3/big/3.jpg","img/cp3/big/4.jpg","img/cp3/big/5.jpg","img/cp3/big/6.jpg"];
var arrcp1 = ["img/cp3/1.jpg","img/cp3/2.jpg","img/cp3/3.jpg","img/cp3/4.jpg","img/cp3/5.jpg","img/cp3/6.jpg"];
//获取屏幕高度
...
$boxs.each(function(i,elem){
	...
	$(elem).click(function(){
		...
		console.log(arrcp1fd3[i])
		$('.bigzhezhaodatu').attr('src',arrcp1fd3[i]);
	})
