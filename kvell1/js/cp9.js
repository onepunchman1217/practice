//大图数组
var arrcp1fd9 = ["img/cp9/big/1.jpg","img/cp9/big/2.jpg","img/cp9/big/3.jpg","img/cp9/big/4.jpg","img/cp9/big/5.jpg","img/cp9/big/6.jpg","img/cp9/big/7.jpg","img/cp9/big/8.jpg"];
var arrcp1 = ["img/cp9/1.jpg","img/cp9/2.jpg","img/cp9/3.jpg","img/cp9/4.jpg","img/cp9/5.jpg","img/cp9/6.jpg","img/cp9/7.jpg","img/cp9/8.jpg"];
//获取屏幕高度
//获取屏幕高度
...
$boxs.each(function(i,elem){
	...
	$(elem).click(function(){
		...
		console.log(arrcp1fd9[i])
		$('.bigzhezhaodatu').attr('src',arrcp1fd9[i]);
	})
