//大图数组
var arrcp1fd10 = ["img/cp10/big/1.jpg","img/cp10/big/2.jpg","img/cp10/big/3.jpg","img/cp10/big/4.jpg","img/cp10/big/5.jpg","img/cp10/big/6.jpg"];
var arrcp1 = ["img/cp10/1.jpg","img/cp10/2.jpg","img/cp10/3.jpg","img/cp10/4.jpg","img/cp10/5.jpg","img/cp10/6.jpg"];
//获取屏幕高度
...
$boxs.each(function(i,elem){
	...
	$(elem).click(function(){
		...
		console.log(arrcp1fd10[i])
		$('.bigzhezhaodatu').attr('src',arrcp1fd10[i]);
	})
